...
class AdaINGen(nn.Module):
    ...
    def __init__(self, input_dim, id_dim, params=None):
        ...
        self.enc_content = ContentEncoder(n_downsample, n_res, input_dim, dim, 'in', activ, pad_type=pad_type,
                                          tanh=False, res_type='basic')

        self.output_dim = self.enc_content.output_dim
        self.dec = Decoder(n_downsample, n_res, self.output_dim, 3, dropout=0, res_norm='adain', activ=activ,
                           pad_type=pad_type, res_type='basic', non_local=0)
