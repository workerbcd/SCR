...
def load_data(args, device = 'cuda'):
    ...
    if args.dataset == 'Airfoil':
        ...
        data_packet = airfoil.get_Airfoil_data_packet(args,f'/home/s4686009/remotedata/DGRegression/{args.dataset}/')
    elif args.dataset == 'NO2':
        assert args.is_ood == 0
        data_packet = no2.get_NO2_data_packet(args,f'/home/s4686009/remotedata/DGRegression/{args.dataset}/')
        ...
        data_packet = cc.get_CommunitiesAndCrime_data_packet(args,f'/home/s4686009/remotedata/DGRegression/{args.dataset}/')

    elif args.dataset == 'SkillCraft':
        data_packet = sc.get_SkillCraft_data_packet(args,f'/home/s4686009/remotedata/DGRegression/{args.dataset}/')
