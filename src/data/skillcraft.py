...
def get_SkillCraft_data_packet(args,path = './data/SkillCraft/'):
    ...
    domain_y_train = y_domain[train_idx]
    domain_y_valid = y_domain[valid_idx]
    domain_y_test = y_domain[test_idx]
    print(y_train)
    ...
    data_packet = {
        ...
        'y_valid': y_valid,
        'y_test': y_test,
        'domain_y_train': domain_y_train,
        'domain_y_valid': domain_y_valid,
        'domain_y_test': domain_y_test
    }
